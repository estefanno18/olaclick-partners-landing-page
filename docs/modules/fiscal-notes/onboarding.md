...
This guide describes the integration flow for the **Fiscal Notes** module. Before starting, make sure you have completed the [Connector registration](/) and understand the [Authentication](https://developers.olaclick.app/docs/api) flow.
